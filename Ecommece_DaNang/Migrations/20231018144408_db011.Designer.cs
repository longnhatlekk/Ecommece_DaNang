...
namespace Ecommece_DaNang.Migrations
{
    ...
    [Migration("20231018144408_db011")]
    partial class db011
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommece_DaNang.Entity.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Ecommece_DaNang.Entity.Orders", b =>
                {
                    ...
                    b.HasOne("Ecommece_DaNang.Entity.Users", "Userss")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
